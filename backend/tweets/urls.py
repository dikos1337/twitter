...
from tweets.views import (CreateCommentView, CreateTweetView, DetailTweetView,
                          FeedTweetsListView, TweetCommentsView,
                          UserTweetsListView)
...
urlpatterns = [
    ...
    path(r'tweet/comments/create/', CreateCommentView.as_view()),
